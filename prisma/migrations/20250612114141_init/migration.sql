...
-- CreateIndex
CREATE INDEX "GeneratedContent_noteId_idx" ON "GeneratedContent"("noteId");
...
-- AddForeignKey
ALTER TABLE "GeneratedContent" ADD CONSTRAINT "GeneratedContent_noteId_fkey" FOREIGN KEY ("noteId") REFERENCES "Note"("id") ON DELETE SET NULL ON UPDATE CASCADE;
